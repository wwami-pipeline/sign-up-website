...
class HomeMap extends React.Component {  
  constructor(props) {
    ...
    console.log("ctor" + this.state.width + " " + this.state.height);
  }
  
  componentDidMount() {
    this.updateWindowDimensions();
    window.addEventListener('resize', this.updateWindowDimensions);
    console.log("mount" + this.state.width + " " + this.state.height);
  }
  
  componentWillUnmount() {
    window.removeEventListener('resize', this.updateWindowDimensions);
    console.log("umount" + this.state.width + " " + this.state.height);
  }
  
  updateWindowDimensions() {
    this.setState({ width: window.innerWidth, height: window.innerHeight });
    console.log("upadte" + this.state.width + " " + this.state.height);
  }

  render() {
    const { classes } = this.props;
    console.log("rend" + this.state.width + " " + this.state.height);
    if (this.state.width < 971) {
      return (
        <div className={classes.imgOverlayWrap}>
          <img src='/images/wwami.png' className={classes.wwamiImage_small}/>
          <svg className={classes.alaska_small} > 
            <g transform="translate(0, 125) scale(0.1, -0.1)" fill="transparent" stroke="none">
              <a xlinkHref="/SHIFA" target="_blank" cursor="pointer">
      ...
      return (
        <div className={classes.imgOverlayWrap}>
          <img src='/images/home_page/wwami_new.png' className={classes.wwamiImage}/>
