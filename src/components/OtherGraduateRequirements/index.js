          ...
          <div className={classes.dialogBody}>
            <DialogContent className={this.props.dialogContent}>
              <Typography className={classes.text}>
                All graduate health sciences students are required to attend a
                fingerstick training prior to performing any blood glucose
                tests. Participation in our programming is limited to UW
                students only.
              </Typography>
              <Typography className={classes.text}>
